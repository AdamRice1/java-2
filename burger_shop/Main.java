...
public class Main {
    public static void main(String[] args) {
        ...
        ham2.addTopping1("pickles", 1.00);
        System.out.println(ham2.priceOfTheBurger());

        Meat meat3 = new Meat("beef");
        Bread bread3 = new Bread("white");
        DeluxeBurger ham3 = new DeluxeBurger(meat3, bread3);
        ham3.addBurgerTopping1("pickles", 2.00);
        System.out.println(ham3.priceOfTheDeluxeBurger());
        // End of Ex. 1
        //Beginning of Ex. 2
        Drink drink1 = new Drink("soda", 1.00);
        String[] item = {"Fries"};
